            ...
            <div className="space-y-2">
              ...
              <div className="flex justify-between text-xs">
                ...
                <span className="text-xs px-1.5 py-0.5 rounded bg-muted text-muted-foreground">
                  {shadowOutcomes.length < 50 ? 'Accumulating' : 'Ready'}
                </span>
              </div>
            </div>
          </div>
        </div>
        {shadowOutcomes.length < 50 && (
          <p className="text-xs text-muted-foreground">
            {shadowOutcomes.length} outcomes recorded. Statistical comparison becomes meaningful at ~50+ resolved outcomes per market.
          </p>
        )}
      </section>
